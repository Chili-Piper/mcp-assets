...
`/copy-user`, `/offboard-user`, `/manage-meeting-types`, `/configure-distro-router`, and `/configure-handoff-router` write to Chili Piper — they default to a dry run and confirm before applying.
